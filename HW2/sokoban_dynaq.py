...
agent = DynaQAgent(num_observations, num_actions, all_actions)
...
for episode in range(1000):
    ...
    agent.save('/Users/xiaojian_xiang/Projects/AI3606/HW2/T2_DynaQ/Q_Table_nozero.npy')

# Save the episode reward
np.save('/Users/xiaojian_xiang/Projects/AI3606/HW2/T2_DynaQ/reward_nozero.npy', episode_rewards)
# Save the episode epsilon
np.save('/Users/xiaojian_xiang/Projects/AI3606/HW2/T2_DynaQ/epsilon_nozero.npy', episode_epsilons)
...
plt.savefig('/Users/xiaojian_xiang/Projects/AI3606/HW2/T2_DynaQ/SO_reward_nozero.png')
plt.show()
...
plt.savefig('/Users/xiaojian_xiang/Projects/AI3606/HW2/T2_DynaQ/SO_epsilon_nozero.png')
plt.show()
